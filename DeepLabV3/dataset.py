...
class DatasetTrain(torch.utils.data.Dataset):
    def __init__(self, cityscapes_data_path, cityscapes_meta_path):
        self.img_dir = cityscapes_data_path + "leftImg8bit_trainvaltest/leftImg8bit/train/"
...
class DatasetVal(torch.utils.data.Dataset):
    def __init__(self, cityscapes_data_path, cityscapes_meta_path):
        self.img_dir = cityscapes_data_path + "leftImg8bit_trainvaltest/leftImg8bit/val/"
        self.label_dir = cityscapes_meta_path + "/label_imgs/"
