...
from core.utils import is_main_process, gather_list

class PartSegIOU:
    def __init__(self, dataset, class_dict):
        self.all_preds = []
        self.all_labels = []
    ...
    def gather(self, local_rank):
        self.all_preds = gather_list(self.all_preds)
        self.all_labels = gather_list(self.all_labels)
    ...
    def compute_metrics(self):
        instance2parts, parts2instance, _ = self.class_dict
